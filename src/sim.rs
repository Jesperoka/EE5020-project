...
/// Standard ERK 4 simulation step with f in a form compatible with hybrid systems.
pub fn rk4_step(
    t: f32,
    f: fn(f32, Vector2<f32>, u8) -> Vector2<f32>,
    x: Vector2<f32>,
    m: u8,
    dt: f32,
) -> Vector2<f32> {
...
/// Convenience helper to simulate a dynamic system one timestep 
